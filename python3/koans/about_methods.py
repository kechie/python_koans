...
class AboutMethods(Koan):
    ...
    def test_calling_functions_with_wrong_number_of_arguments(self):
        ...
        self.assertRegexpMatches(msg, 'takes 2 positional arguments')
    ...
    def test_the_documentation_can_be_viewed_with_the_doc_method(self):
        self.assertRegexpMatches(self.method_with_documentation.__doc__, 'A string placed at the beginning')
